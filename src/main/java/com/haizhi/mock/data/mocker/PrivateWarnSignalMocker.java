 ...
 */
@Component
public class PrivateWarnSignalMocker implements Mocker<PrivateWarnSignalDO> {

    @Override
    public PrivateWarnSignalDO mockData(int i) {
        return new PrivateWarnSignalDO()
                ...
                .custStu(String.valueOf(RandomUtils.nextIntClosed(1)))
                .custStuDate(LocalDate.now().toString())
